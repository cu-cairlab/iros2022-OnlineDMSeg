...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        #print(x2.size())
        x = self.layer3(x)
        #torch.add(self.extra2(x),x2,out=x2)
        #x3 = self.extra2(x)
        ...
        x22 = self.extra2(x)
        #print(x22.size())
        #print(nn.functional.pad(x22,(0,x2.size()[2]-x22.size()[2],0,x2.size()[3]-x22.size()[3])).size())
        ...
        x = self.layer4(x)
        #x4 = self.extra3(x)
        #torch.add(self.extra3(x),x2,out=x2)
        #print(x2.size())
        #print("layer4")
        #print(x.size())
        #print("check")
