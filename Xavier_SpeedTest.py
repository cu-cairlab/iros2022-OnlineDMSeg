...
parser.add_argument('--dataPath', type=str, default='/media/Data/row001_auto/color/cam0_images/',
                    help='path to data')
...
speedTest.speedTest(args,img_dir,model,is_seperate_classifier,classifier)
...
speedTest.speedTest(args,img_dir,model_trt,is_seperate_classifier,classifier)
